...
in
{
  config.gitlab-ci = {
    ...
    image = lib.mkIf (config.image != null && rootConfig.gitlab-ci.images.enable) (
      ci-lib.resolveImage rootConfig.gitlab-ci.images.repository imageRegistry config.image
    );
